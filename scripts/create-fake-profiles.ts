...
// Configuration
const SUPABASE_URL = `https://mjhhlswqrjzrhgeozzev.supabase.co`;
const SUPABASE_SERVICE_ROLE_KEY = `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im1qaGhsc3dxcmp6cmhnZW96emV2Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1NTY4NzY3MCwiZXhwIjoyMDcxMjYzNjcwfQ.Eibpk5KdzkavoZQaGx3es-yTSeREozh0E27fKiXbUDQ`;
